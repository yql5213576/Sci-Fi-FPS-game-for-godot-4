...
func _physics_process(delta: float) -> void:
	if ready_to_scene==false:
		if UserData.texture_size_data==256:
			...
			var ammo_material:Resource=preload("res://assets/materials_prefab/pistol/ammo/256/ammo.tres")
			$magazine.set_surface_override_material(0,magazine_material)
			$ammo_pistol.set_surface_override_material(0,ammo_material)
		
		if UserData.texture_size_data==512:
			var magazine_material:Resource=preload("res://assets/materials_prefab/pistol/512/magazine.tres")
			var ammo_material:Resource=preload("res://assets/materials_prefab/pistol/ammo/512/ammo.tres")
			$magazine.set_surface_override_material(0,magazine_material)
			$ammo_pistol.set_surface_override_material(0,ammo_material)
		
		if UserData.texture_size_data==1024:
			var magazine_material:Resource=preload("res://assets/materials_prefab/pistol/1024/magazine.tres")
			var ammo_material:Resource=preload("res://assets/materials_prefab/pistol/ammo/1024/ammo.tres")
			$magazine.set_surface_override_material(0,magazine_material)
			$ammo_pistol.set_surface_override_material(0,ammo_material)
