...
func player_into_scene():
	...
	if Main_Menu_Global.setting_bot_num_i==0:
		if self.player_team=="blue":
			if player_into_n==0:
				instance_player(scene_root.ai_blue_points_lib_id[0])
				player_into_n=1
				player_into_bool=false
				return
		if self.player_team=="red":
			if player_into_n==0:
				instance_player(scene_root.ai_red_points_lib_id[0])
				player_into_n=1
				player_into_bool=false
				return
	...
	if Main_Menu_Global.setting_bot_num_i==1:#1v1
		if self.player_team=="blue":
			if player_into_n==0:
				...
				return
			if player_into_n==1:
				instance_ai("red",2,2,scene_root.ai_red_points_lib_id[0])
				player_into_n=2
				player_into_bool=false
				return
		...
		if self.player_team=="red":
			if player_into_n==0:
				...
				return
			if player_into_n==1:
				instance_ai("blue",2,2,scene_root.ai_blue_points_lib_id[0])
				player_into_n=2
				player_into_bool=false
				return
	...
	if Main_Menu_Global.setting_bot_num_i==3:#2v2
		if self.player_team=="blue":
			...
			if player_into_n==1:
				...
				return
			if player_into_n==2:
				instance_ai("red",3,3,scene_root.ai_red_points_lib_id[1])
				player_into_n=3
				player_into_bool=false
				return
			if player_into_n==3:
				instance_ai("blue",4,4,scene_root.ai_blue_points_lib_id[1])
				player_into_n=4
				player_into_bool=false
				return
		...
		if self.player_team=="red":
			...
			if player_into_n==1:
				...
				return
			if player_into_n==2:
				instance_ai("blue",3,3,scene_root.ai_blue_points_lib_id[1])
				player_into_n=3
				player_into_bool=false
				return
			if player_into_n==3:
				instance_ai("red",4,4,scene_root.ai_red_points_lib_id[1])
				player_into_n=4
				player_into_bool=false
				return
	if Main_Menu_Global.setting_bot_num_i==5:#3v3
		if self.player_team=="blue":
			...
			if player_into_n==2:
				...
				return
			if player_into_n==3:
				instance_ai("red",4,4,scene_root.ai_red_points_lib_id[2])
				player_into_n=4
				player_into_bool=false
				return
			if player_into_n==4:
				instance_ai("blue",5,5,scene_root.ai_blue_points_lib_id[1])
				player_into_n=5
				player_into_bool=false
				return
			if player_into_n==5:
				instance_ai("blue",6,6,scene_root.ai_blue_points_lib_id[2])
				player_into_n=6
				player_into_bool=false
				return
		...
		if self.player_team=="red":
			...
			if player_into_n==2:
				...
				return
			if player_into_n==3:
				instance_ai("blue",4,4,scene_root.ai_blue_points_lib_id[2])
				player_into_n=4
				player_into_bool=false
				return
			if player_into_n==4:
				instance_ai("red",5,5,scene_root.ai_red_points_lib_id[1])
				player_into_n=5
				player_into_bool=false
				return
			if player_into_n==5:
				instance_ai("red",6,6,scene_root.ai_red_points_lib_id[2])
				player_into_n=6
				player_into_bool=false
				return
	...
	if Main_Menu_Global.setting_bot_num_i==7:#4v4
		if self.player_team=="blue":
			...
			if player_into_n==3:
				...
				return
			if player_into_n==4:
				instance_ai("red",5,5,scene_root.ai_red_points_lib_id[3])
				player_into_n=5
				player_into_bool=false
				return
			if player_into_n==5:
				instance_ai("blue",6,6,scene_root.ai_blue_points_lib_id[1])
				player_into_n=6
				player_into_bool=false
				return
			if player_into_n==6:
				instance_ai("blue",7,7,scene_root.ai_blue_points_lib_id[2])
				player_into_n=7
				player_into_bool=false
				return
			if player_into_n==7:
				instance_ai("blue",8,8,scene_root.ai_blue_points_lib_id[3])
				player_into_n=8
				player_into_bool=false
				return
		...
		if self.player_team=="red":
			...
			if player_into_n==3:
				...
				return
			if player_into_n==4:
				instance_ai("blue",5,5,scene_root.ai_blue_points_lib_id[3])
				player_into_n=5
				player_into_bool=false
				return
			if player_into_n==5:
				instance_ai("red",6,6,scene_root.ai_red_points_lib_id[1])
				player_into_n=6
				player_into_bool=false
				return
			if player_into_n==6:
				instance_ai("red",7,7,scene_root.ai_red_points_lib_id[2])
				player_into_n=7
				player_into_bool=false
				return
			if player_into_n==7:
				instance_ai("red",8,8,scene_root.ai_red_points_lib_id[3])
				player_into_n=8
				player_into_bool=false
				return
	...
	if Main_Menu_Global.setting_bot_num_i==9:#5v5
		if self.player_team=="blue":
			...
			if player_into_n==4:
				...
				return
			if player_into_n==5:
				instance_ai("red",6,6,scene_root.ai_red_points_lib_id[4])
				player_into_n=6
				player_into_bool=false
				return
			if player_into_n==6:
				instance_ai("blue",7,7,scene_root.ai_blue_points_lib_id[1])
				player_into_n=7
				player_into_bool=false
				return
			if player_into_n==7:
				instance_ai("blue",8,8,scene_root.ai_blue_points_lib_id[2])
				player_into_n=8
				player_into_bool=false
				return
			if player_into_n==8:
				instance_ai("blue",9,9,scene_root.ai_blue_points_lib_id[3])
				player_into_n=9
				player_into_bool=false
				return
			if player_into_n==9:
				instance_ai("blue",10,10,scene_root.ai_blue_points_lib_id[4])
				player_into_n=10
				player_into_bool=false
				return
			...
			if player_into_n==4:
				...
				return
			if player_into_n==5:
				instance_ai("blue",6,6,scene_root.ai_blue_points_lib_id[4])
				player_into_n=5
				player_into_bool=false
				return
			if player_into_n==6:
				instance_ai("red",7,7,scene_root.ai_red_points_lib_id[1])
				player_into_n=6
				player_into_bool=false
				return
			if player_into_n==7:
				instance_ai("red",8,8,scene_root.ai_red_points_lib_id[2])
				player_into_n=7
				player_into_bool=false
				return
			if player_into_n==8:
				instance_ai("red",9,9,scene_root.ai_red_points_lib_id[3])
				player_into_n=8
				player_into_bool=false
				return
			if player_into_n==9:
				instance_ai("red",10,10,scene_root.ai_red_points_lib_id[4])
				player_into_n=10
				player_into_bool=false
				return
	...
	if Main_Menu_Global.setting_bot_num_i==11:#6v6
		if self.player_team=="blue":
			...
			if player_into_n==5:
				...
				return
			if player_into_n==6:
				instance_ai("red",7,7,scene_root.ai_red_points_lib_id[5])
				player_into_n=7
				player_into_bool=false
				return
			if player_into_n==7:
				instance_ai("blue",8,8,scene_root.ai_blue_points_lib_id[1])
				player_into_n=8
				player_into_bool=false
				return
			if player_into_n==8:
				instance_ai("blue",9,9,scene_root.ai_blue_points_lib_id[2])
				player_into_n=9
				player_into_bool=false
				return
			if player_into_n==9:
				instance_ai("blue",10,10,scene_root.ai_blue_points_lib_id[3])
				player_into_n=10
				player_into_bool=false
				return
			if player_into_n==10:
				instance_ai("blue",11,11,scene_root.ai_blue_points_lib_id[4])
				player_into_n=11
				player_into_bool=false
				return
			if player_into_n==11:
				instance_ai("blue",12,12,scene_root.ai_blue_points_lib_id[5])
				player_into_n=12
				player_into_bool=false
				return
		...
		if self.player_team=="red":
			...
			if player_into_n==5:
				...
				return
			if player_into_n==6:
				instance_ai("blue",7,7,scene_root.ai_blue_points_lib_id[5])
				player_into_n=7
				player_into_bool=false
				return
			if player_into_n==7:
				instance_ai("red",8,8,scene_root.ai_red_points_lib_id[1])
				player_into_n=8
				player_into_bool=false
				return
			if player_into_n==8:
				instance_ai("red",9,9,scene_root.ai_red_points_lib_id[2])
				player_into_n=9
				player_into_bool=false
				return
			if player_into_n==9:
				instance_ai("red",10,10,scene_root.ai_red_points_lib_id[3])
				player_into_n=10
				player_into_bool=false
				return
			if player_into_n==10:
				instance_ai("red",11,11,scene_root.ai_red_points_lib_id[4])
				player_into_n=11
				player_into_bool=false
				return
			if player_into_n==11:
				instance_ai("red",12,12,scene_root.ai_red_points_lib_id[5])
				player_into_n=12
				player_into_bool=false
				return
	...
	if Main_Menu_Global.setting_bot_num_i==13:#7v7
		if self.player_team=="blue":
			...
			if player_into_n==6:
				...
				return
			if player_into_n==7:
				instance_ai("red",8,8,scene_root.ai_red_points_lib_id[6])
				player_into_n=8
				player_into_bool=false
				return
			if player_into_n==8:
				instance_ai("blue",9,9,scene_root.ai_blue_points_lib_id[1])
				player_into_n=9
				player_into_bool=false
				return
			if player_into_n==9:
				instance_ai("blue",10,10,scene_root.ai_blue_points_lib_id[2])
				player_into_n=10
				player_into_bool=false
				return
			if player_into_n==10:
				instance_ai("blue",11,11,scene_root.ai_blue_points_lib_id[3])
				player_into_n=11
				player_into_bool=false
				return
			if player_into_n==11:
				instance_ai("blue",12,12,scene_root.ai_blue_points_lib_id[4])
				player_into_n=12
				player_into_bool=false
				return
			if player_into_n==12:
				instance_ai("blue",13,13,scene_root.ai_blue_points_lib_id[5])
				player_into_n=13
				player_into_bool=false
				return
			if player_into_n==13:
				instance_ai("blue",14,14,scene_root.ai_blue_points_lib_id[6])
				player_into_n=14
				player_into_bool=false
				return
		...
		if self.player_team=="red":
			...
			if player_into_n==6:
				...
				return
			if player_into_n==7:
				instance_ai("blue",8,8,scene_root.ai_blue_points_lib_id[6])
				player_into_n=8
				player_into_bool=false
				return
			if player_into_n==8:
				instance_ai("red",9,9,scene_root.ai_red_points_lib_id[1])
				player_into_n=9
				player_into_bool=false
				return
			if player_into_n==9:
				instance_ai("red",10,10,scene_root.ai_red_points_lib_id[2])
				player_into_n=10
				player_into_bool=false
				return
			if player_into_n==10:
				instance_ai("red",11,11,scene_root.ai_red_points_lib_id[3])
				player_into_n=11
				player_into_bool=false
				return
			if player_into_n==11:
				instance_ai("red",12,12,scene_root.ai_red_points_lib_id[4])
				player_into_n=12
				player_into_bool=false
				return
			if player_into_n==12:
				instance_ai("red",13,13,scene_root.ai_red_points_lib_id[5])
				player_into_n=13
				player_into_bool=false
				return
			if player_into_n==13:
				instance_ai("red",13,13,scene_root.ai_red_points_lib_id[6])
				player_into_n=14
				player_into_bool=false
				return
	...
	if Main_Menu_Global.setting_bot_num_i==15:#8v8
		if self.player_team=="blue":
			...
			if player_into_n==7:
				...
				return
			if player_into_n==8:
				instance_ai("red",9,9,scene_root.ai_red_points_lib_id[7])
				player_into_n=9
				player_into_bool=false
				return
			if player_into_n==9:
				instance_ai("blue",10,10,scene_root.ai_blue_points_lib_id[1])
				player_into_n=10
				player_into_bool=false
				return
			if player_into_n==10:
				instance_ai("blue",11,11,scene_root.ai_blue_points_lib_id[2])
				player_into_n=11
				player_into_bool=false
				return
			if player_into_n==11:
				instance_ai("blue",12,12,scene_root.ai_blue_points_lib_id[3])
				player_into_n=12
				player_into_bool=false
				return
			if player_into_n==12:
				instance_ai("blue",13,13,scene_root.ai_blue_points_lib_id[4])
				player_into_n=13
				player_into_bool=false
				return
			if player_into_n==13:
				instance_ai("blue",14,14,scene_root.ai_blue_points_lib_id[5])
				player_into_n=14
				player_into_bool=false
				return
			if player_into_n==14:
				instance_ai("blue",15,15,scene_root.ai_blue_points_lib_id[6])
				player_into_n=15
				player_into_bool=false
				return
			if player_into_n==15:
				instance_ai("blue",16,16,scene_root.ai_blue_points_lib_id[7])
				player_into_n=16
				player_into_bool=false
				return
		if self.player_team=="red":
			...
			if player_into_n==7:
				...
				return
			if player_into_n==8:
				instance_ai("blue",9,9,scene_root.ai_blue_points_lib_id[7])
				player_into_n=9
				player_into_bool=false
				return
			if player_into_n==9:
				instance_ai("red",10,10,scene_root.ai_red_points_lib_id[1])
				player_into_n=10
				player_into_bool=false
				return
			if player_into_n==10:
				instance_ai("red",11,11,scene_root.ai_red_points_lib_id[2])
				player_into_n=11
				player_into_bool=false
				return
			if player_into_n==11:
				instance_ai("red",12,12,scene_root.ai_red_points_lib_id[3])
				player_into_n=12
				player_into_bool=false
				return
			if player_into_n==12:
				instance_ai("red",13,13,scene_root.ai_red_points_lib_id[4])
				player_into_n=13
				player_into_bool=false
				return
			if player_into_n==13:
				instance_ai("red",14,14,scene_root.ai_red_points_lib_id[5])
				player_into_n=14
				player_into_bool=false
				return
			if player_into_n==14:
				instance_ai("red",15,15,scene_root.ai_red_points_lib_id[6])
				player_into_n=15
				player_into_bool=false
				return
			if player_into_n==15:
				instance_ai("red",16,16,scene_root.ai_red_points_lib_id[7])
				player_into_n=16
				player_into_bool=false
				return
			
func instance_player(t_pos):
...
func instance_ai(color,point_id,bot_id,t_pos):
	if scene_root.mode=="team_death_match":
