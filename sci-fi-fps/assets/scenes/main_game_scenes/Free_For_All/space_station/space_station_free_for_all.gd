...
@onready var current_map_scene="res://assets/scenes/main_game_scenes/Free_For_All/space_station/space_station_free_for_all.tscn"
...
func _physics_process(delta: float) -> void:
	...
	if saturation_event:
		...
		space_station_environment.adjustment_saturation=0
