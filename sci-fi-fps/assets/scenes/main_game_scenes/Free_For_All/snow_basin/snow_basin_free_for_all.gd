...
@onready var current_map_scene:String="res://assets/scenes/main_game_scenes/Free_For_All/snow_basin/snow_basin_free_for_all.tscn"
...
func _physics_process(delta: float) -> void:
	...
	if saturation_event:
		snow_basin_environment.adjustment_saturation=Vector2(snow_basin_environment.adjustment_saturation,0).lerp(Vector2(1.2,0),0.005).x
	else:
		snow_basin_environment.adjustment_saturation=0
