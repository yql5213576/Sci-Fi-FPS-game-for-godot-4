...
@onready var current_map_scene:String="res://assets/scenes/main_game_scenes/Team_Death_Match/space_station_simple/space_station_simple_team_death_match.tscn"
...
func _physics_process(delta: float) -> void:
	...
	if saturation_event:
		space_station_simple_environment.adjustment_saturation=Vector2(space_station_simple_environment.adjustment_saturation,0).lerp(Vector2(1.2,0),0.005).x
	else:
		space_station_simple_environment.adjustment_saturation=Vector2(space_station_simple_environment.adjustment_saturation,0).lerp(Vector2(0,0),0.1).x
